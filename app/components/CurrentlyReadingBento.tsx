...
export function CurrentlyReadingBento() {
  return (
    <BentoCard height="h-full" className="group">
      <h2 className="mb-2 text-white font-medium">Currently Reading</h2>
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 h-full w-full bg-gradient-to-t from-slate-900 via-transparent to-transparent"></div>
    </BentoCard>
  );
}
